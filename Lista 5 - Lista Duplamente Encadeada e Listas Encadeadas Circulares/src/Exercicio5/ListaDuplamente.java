...
public class ListaDuplamente
{
	...
	{
		return verificaIgualdade(this.prim, lista2.prim);
	}

	//0(N)
	private boolean verificaIgualdade(Elo l1, Elo l2)
	{
		if (l1 == null && l2 == null) return true; //chegou no final das duas sem encontrar desigualdade, logo é igual
		if (l1 == null || l2 == null) return false; //acabou umas das duas listas primeiro, logo não é igual
		if (l1.dado != l2.dado) return false;

		return verificaIgualdade(l1.prox, l2.prox);
	}
