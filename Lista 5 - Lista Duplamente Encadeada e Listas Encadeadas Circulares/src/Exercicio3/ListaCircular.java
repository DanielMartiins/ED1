...
public class ListaCircular extends Lista
{
	...
	Chamo a função insere() apenas uma vez fora do loop, e nesse caso vai executar em O(1) por estar vazia
	A lista resultante já estará invertida porque eu inseri no inicio da lista de forma manual, sem
	usar o método insere() dentro do loop que por sua vez insere no final
	 */
	public ListaCircular inverteLista() {
		...
		//Nesse momento, o ultimo elemento da lista invertida está cíclico em sí próprio.
		//Por isso, o loop abaixo vai iterar até que p.prox seja sí próprio, para consertar isso
