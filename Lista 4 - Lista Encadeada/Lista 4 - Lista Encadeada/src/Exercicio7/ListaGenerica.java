...
public class ListaGenerica<T1> {
    ...
    protected class Elo {
        ...
        public Elo(T1 elem, Elo proxElem) {
            dado = elem;
            prox = proxElem;
        }
    }
    ...
    public boolean buscaRecursiva(T1 elem) {
        if (this.vazia())
            return false;
    ...
    private boolean buscaRecursiva(T1 elem, Elo p) {
        if (p == null)
            return false;
